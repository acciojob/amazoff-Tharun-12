...
public class OrderRepository
{
    ...
    // Second one is delivary partner database named as partnerDatabase
    private Map<String,DeliveryPartner> partnerDatabase;
    // Third one is order-partner pair database named as partnerOrderDatabase
    ...
    public int getOrdersCountByPartnerId(String partnerId){
