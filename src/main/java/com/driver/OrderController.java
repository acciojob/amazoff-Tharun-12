...
public class OrderController {
    ...
    public ResponseEntity<Integer> getOrdersCountByPartnerId(@PathVariable String partnerId){

        Integer orderCount = orderService.getOrdersCountByPartnerId(partnerId) ;
